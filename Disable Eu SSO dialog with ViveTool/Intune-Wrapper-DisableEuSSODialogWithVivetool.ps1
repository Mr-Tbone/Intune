...
$AppGuid        = "{FEEDBEEF-BEEF-BEEF-BEEF-FEEDBEEF0001}"  
# If using MSI detection method in Intune the AppGuid must be converted to a valid MSI GUID format.
# This can be done by a special reformating and reordering the app guid. the above example would be: {FEEBDEEF-FEEB-FEEB-EBFE-FEEDBEEF0001}

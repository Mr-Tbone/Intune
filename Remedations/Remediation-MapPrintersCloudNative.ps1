...
.EXAMPLE
    .\Intune - Printer Mapping.ps1
    When deployed via Intune as SYSTEM, creates scheduled task and scripts for printer mapping.

.EXAMPLE
    .\Intune - Printer Mapping.ps1 -LogVerboseEnabled $true -LogToDisk $true

...
.RELEASENOTES
    ...
    3.0.0 2026-04-30 Major Update with locgic and new functions
#>
...
param(
    ...
    [string]$ScriptActionName       = "Map Drives",

    [Parameter(                             HelpMessage = 'Specify how to run the script: Install, ReInstall or UnInstall')]    
    [validateset("Install", "ReInstall", "UnInstall")]
    [string]$InstallType            = "Install",

    [Parameter(                             HelpMessage = 'Register the App in Add Remove Programs for versioning and uninstall')]
...
#Start as Compliant and change later if non-compliant
...
# Determine remediation execution mode based on script filename only
